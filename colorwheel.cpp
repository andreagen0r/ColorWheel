...
void ColorWheel::drawIndicators(QPainter *inPainter)
{
    ...
    inPainter->drawEllipse(mIndicatorPosition, indicatorSize -1 , indicatorSize - 1);
}
...
void ColorWheel::resizeEvent(QResizeEvent *event)
{
   ...
   indicatorSize = mInnerRadius * 0.04;
